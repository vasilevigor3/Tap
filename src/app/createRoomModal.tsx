    ...
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50 z-50 ">
      <div className="bg-white p-6 rounded-lg shadow-lg ">
        ...
        <form onSubmit={handleSubmit}>
          <Input type="text" placeholder="Room Name" className="text-gray-500 font-bold mb-4"
            value={roomName}
            onChange={(e) => setRoomName(e.target.value)} />
          <Input type="number" placeholder="Number of Players" className="text-gray-500 font-bold mb-4"
            value={numPlayers}
            onChange={(e) => setNumPlayers(e.target.value)} />
          <Input type="number" placeholder="Bet" className="text-gray-500 font-bold mb-4"
            value={bet}
